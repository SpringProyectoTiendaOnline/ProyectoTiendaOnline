...
public class ProductoController {
	...
	public ModelAndView listAllProductosForClients(@PathVariable("idCliente") long idCliente,  HttpServletRequest request) {
		ModelAndView mav = new ModelAndView();
	...
	public ModelAndView listAllProductosForClients(HttpServletRequest request) {
		ModelAndView mav = new ModelAndView();
